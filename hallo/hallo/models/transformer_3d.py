...
class Transformer3DModel(ModelMixin, ConfigMixin):
    ...
    def __init__(
        ...
        return_cross_attention: bool = None,
        timestep: int = None,
        is_final_block : bool = None,
        layer_idx: int = None,
    ):
        super().__init__()
        ...
        **kwargs
        ...
        for _, block in enumerate(self.transformer_blocks):
            if isinstance(block, TemporalBasicTransformerBlock):
                ...
                if return_cross_attention and (timestep_now == 24) and is_final_block and layer_idx == 2:
                    out = block(
        ...
        if not return_dict:
            if attn_feat is not None:
                return (hidden_states, motion_frames, attn_feat)
            else:
